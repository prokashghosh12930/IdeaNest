...
const Login = () => {
  ...
  function handleCallbackResponse(res) {
    ...
    axios.post("http://localhost/api/oauth.php", sendData).then((result) => {
      window.localStorage.setItem("token", result.data.token);
      window.localStorage.setItem("user_id", result.data.user_id);
      console.log("From Outh api - ", result.data);
      navigate("/user");
    });
  }
  ...
  useScript("https://accounts.google.com/gsi/client", () => {
    window.google.accounts.id.initialize({
      client_id:
        "925771794516-c41uu1tbkianfjig93kqomqkbffpsbgg.apps.googleusercontent.com",
  ...
  return (
    <>
      ...
      C37.505,50.156,37.135,49.856,36.791,49.513z"
              ...
              <path
                style={{ fill: "#A4E869" }}
                d="M50.439,20.132c-0.276,0.383-0.576,0.753-0.92,1.097l-5.657,5.657
	...
	c4.277-0.69,7.574-4.411,7.574-8.875S54.716,20.821,50.439,20.132z"
              ...
              <path
                style={{ fill: "#EFCE4A" }}
                d="M49.519,8.5C46.363,5.344,41.4,5.044,37.888,7.58c0.075,0.466,0.125,0.94,0.125,1.426v8
	...
	c1.247-0.43,2.42-1.13,3.411-2.121l5.657-5.657c0.344-0.344,0.644-0.714,0.92-1.097C52.976,16.619,52.675,11.657,49.519,8.5z"
              ...
              <path
                style={{ fill: "#61B872" }}
                d="M50.439,37.882c-0.466,0.075-0.94,0.125-1.426,0.125h-8c-1.402,0-2.726-0.334-3.912-0.912
	...
	l5.657,5.657c0.344,0.344,0.714,0.644,1.097,0.92c3.512,2.536,8.475,2.236,11.631-0.92S52.976,41.394,50.439,37.882z"
              ...
              <path
                style={{ fill: "#ED7161" }}
                d="M29.013,17.569c-0.43-1.247-1.13-2.42-2.121-3.411L21.235,8.5c-0.344-0.344-0.714-0.644-1.097-0.92
	...
	s0.581-0.641,0.836-0.982c0.561-0.752,0.99-1.571,1.285-2.429C29.671,21.564,29.671,19.478,29.013,17.569z"
              ...
              <path
                style={{ fill: "#BF4D90" }}
                d="M17,20.007H9c-0.482,0-0.952,0.049-1.414,0.123c0,0,0.001,0.001,0.001,0.002
	...
	c0.854-0.294,1.668-0.721,2.417-1.278C25.271,23.38,21.515,20.007,17,20.007z"
              ...
              <path
                style={{ fill: "#9777A8" }}
                d="M26.892,31.128c-0.309-0.309-0.641-0.581-0.982-0.836c-0.752-0.561-1.571-0.99-2.429-1.285
	...
	C27.473,31.769,27.201,31.437,26.892,31.128z"
          ...
          <h1 className="text-3xl font-Emilys font-semibold mt-4">
            Welcome To IdeaNest
          </h1>
          <form
            autoComplete="off"
          ...
          >
            ...
            <input
              ...
              className="w-[25rem] mt-2.5 bg-[#efefef] outline-none py-3 px-4 rounded-full font-Poppins 
                    text-sm"
              name="email"
            ...
            <button
              className="w-[25rem] mt-8 bg-[#e60022] text-white outline-none py-2.5 px-4 rounded-full font-Poppins 
                    text-md "
            >
              {loading && <Progressing />}
              {!loading && "Login"}
          ...
          <NavLink to="/signup">
            <h4 className="text-sm mt-4">
              ...
              <span className="cursor-pointer font-semibold">Signup</span>
            </h4>
          </NavLink>
        </div>
